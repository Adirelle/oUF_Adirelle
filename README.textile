...
Though oUF_Adirelle embeds and uses some libraries, they are all optional and could be safely removed (just delete the "libs" directory). Please note the "/oufa" command yet requires LibMovable-1.0 to work.
...
* display curable debuffs in the center of the frame ; debuffs you can dispell are opaque, debuffs you cannot are half transparent.
* displat important debuffs (boss debuff or PvP control abilities).
