...
oUF:Factory(function()
	...
	local GetInstanceInfo = assert(_G.GetInstanceInfo, "_G.GetInstanceInfo is undefined")
	local GetNumGroupMembers = assert(_G.GetNumGroupMembers, "_G.GetNumGroupMembers is undefined")
	...
	local IsInActiveWorldPVP = assert(_G.IsInActiveWorldPVP, "_G.IsInActiveWorldPVP is undefined")
